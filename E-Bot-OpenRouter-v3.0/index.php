...
<script>
    ...
    document.addEventListener('DOMContentLoaded', function() {
        // Load saved theme preference on page load. Dark mode is the
        // default (the <body> tag already has the dark-mode class set),
        // so light mode is only applied when explicitly saved.
